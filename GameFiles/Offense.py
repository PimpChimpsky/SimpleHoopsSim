...
class OffensiveGeneration:
    ...
    #set minimum and maximum skill level
        ...
        ThreePointSkill = OffensiveGeneration.ThreePointGeneration(height, wingspan)
        MidrangeSkill = OffensiveGeneration.MidRangeGeneration(height,wingspan)
        FreeThrowSkill = OffensiveGeneration.FreeThrowGeneration(height, wingspan)
        PostScoringSkill = OffensiveGeneration.PostScoringGeneration(height, wingspan, weight)
        LayupSkill = OffensiveGeneration.LayupsGeneration(wingspan, speed, footwork)
        FloaterSkill = OffensiveGeneration.FloaterGeneration(wingspan, speed, footwork)
        DunkSkill = OffensiveGeneration.DunkGeneration(wingspan, strength, vertical, footwork)
    ...
    def ThreePointGeneration(height, wingspan):
        ...
        heightParameters = OffensiveGeneration.GetParameters(height, "heightRange", skillParameters)
        wingspanParameters = OffensiveGeneration.GetParameters(wingspan, "wingspanRange", skillParameters)
    ...
    def PostScoringGeneration(height, wingspan, weight):
        ...
        heightParameters = OffensiveGeneration.GetParameters(height, "heightRange", skillParameters)
        weightParamaters = OffensiveGeneration.GetParameters(weight, "weightRange", skillParameters)
        wingspanParameters = OffensiveGeneration.GetParameters(wingspan, "wingspanRange", skillParameters)
    ...
    def LayupsGeneration(wingspan, speed, footwork):
        ...
        speedParameters = OffensiveGeneration.GetParameters(speed, "speedRange", skillParameters)
        wingspanParameters = OffensiveGeneration.GetParameters(wingspan, "wingspanRange", skillParameters)
        footworkParameters = OffensiveGeneration.GetParameters(footwork, "footworkRange", skillParameters)
    ...
    def DunkGeneration(wingspan, strength, vertical, footwork):
        ...
        wingspanParameters = OffensiveGeneration.GetParameters(wingspan, "wingspanRange", skillParameters)
        strengthParameters = OffensiveGeneration.GetParameters(strength, "strengthRange", skillParameters)
        verticalParameters = OffensiveGeneration.GetParameters(vertical, "verticalRange", skillParameters)
        footworkParameters = OffensiveGeneration.GetParameters(footwork, "footworkRange", skillParameters)
